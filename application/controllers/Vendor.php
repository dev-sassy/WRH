...
class Vendor extends CI_Controller {
    ...
    public function addVendor() {
        ...
        if ($this->input->post('add_vendor')) {
            ...
            $this->form_validation->set_rules('vendorName', 'Vendor name', "trim|required|is_unique[wrh_vendor.vendorName]|min_length[2]|max_length[150]|regex_match[/^[a-zA-Z' ]+$/]", array("is_unique" => "Vendor name already exist."));
